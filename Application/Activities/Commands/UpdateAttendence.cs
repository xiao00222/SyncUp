...
public class UpdateAttendence
{
    ...
    public class Handler(IUserAccessor userAccessor, ApplicationDbContext context) : IRequestHandler<Command, Result<Unit>>
    {
        public async Task<Result<Unit>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            {
                activity.Attendees.Add(new ActivityAttendees
                {
                    UserId = user.Id,
