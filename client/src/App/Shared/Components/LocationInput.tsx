...
const LocationInput = <T extends FieldValues>(props: Props<T>) => {
  ...
  const LocationUrl =
    "https://api.locationiq.com/v1/autocomplete?key=pk.5eddb8ca8d5cc1e0c363d9ee29fbfded&q=tower%20of%20lo%20&limit=5&dedupe=1&";
  ...
  const handleSelect = (location: LocationIQSuggestion) => {
    ...
    const lattitude = parseFloat(location.lat); // ← parse to number
